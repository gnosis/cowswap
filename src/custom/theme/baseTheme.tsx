...
import { cowSwapBackgroundDay, cowSwapBackgroundNight, cowSwapLogo } from './cowSwapAssets'
...
export function themeVariables(darkMode: boolean, colorsTheme: Colors) {
  const chosenBg = darkMode ? cowSwapBackgroundDay : cowSwapBackgroundNight
  console.log('chosenbg', cowSwapBackgroundDay)
  return {
    body: {
      background: css`
        background: rgba(164, 211, 227, 1);
        background: url(data:image/svg+xml;base64,${chosenBg}) no-repeat 100% / cover fixed,
          ${darkMode
