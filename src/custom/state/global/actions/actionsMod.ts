...
import { WithChainId, setDefaultChainId } from '../../lists/actions'
...
export const updateVersion = createAction('global/updateVersion', (payload: WithChainId) => setDefaultChainId(payload))
