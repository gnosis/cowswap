        ...
        <ContentWrapper gap="lg">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              <Trans>
                As a member of the Cowswap community you may claim vCOW to be used for voting and governance.
                <br />
                <br />
                <ExternalLink href="https://uniswap.org/blog/uni">Read more about vCOW</ExternalLink>
              </Trans>
            </TYPE.subHeader>
            <ButtonPrimary
