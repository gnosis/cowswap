...
export default function About() {
  return (
    <Page>
      ...
      <p>
        <strong>CowSwap</strong> is a Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin vitae blandit
        leo. Etiam consequat diam eu tortor scelerisque mattis. Nulla eu lacus accumsan, consequat ante et, molestie ex.
        Cras eu ante nisl. Vestibulum ut sagittis ex. Praesent et metus a ligula porta interdum.
      </p>
      ...
      <p>
        Gas costs are accounted for in your sell token already - no gas costs need to be paid! CowSwap uses an off-chain
        design for submitting trades:
      </p>
      <ol>
